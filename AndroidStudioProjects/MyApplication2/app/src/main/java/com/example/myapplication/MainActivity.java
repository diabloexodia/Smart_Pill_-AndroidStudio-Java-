...
// Put your S3 upload code here
            timingEditText = findViewById(R.id.time);
            dosageEdittext = findViewById(R.id.dosage);
            naemEditText = findViewById(R.id.name);
            String FinalpillConfig="Patient Name: "+naemEditText.getText().toString()+"\n Time of consumption: "+timingEditText.getText().toString()+"\n Dosage(Nos): "+dosageEdittext.getText().toString();
